...
public class Functions {
    ...
    public static DataPoint<Double> getGaugeDataPointWithSingleTimesatmp(Row row) {
        return new DataPoint<>(
                UUIDs.unixTimestamp(row.getUUID(GAUGE_ALL_COLS.TIME.ordinal())),
                row.getDouble(GAUGE_ALL_COLS.VALUE.ordinal()),
