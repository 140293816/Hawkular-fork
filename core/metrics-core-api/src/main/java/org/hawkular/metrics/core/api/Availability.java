 ...
 * @author John Sanda
 */
public class Availability extends Metric<AvailabilityData> {

    @JsonCreator
    public Availability(@JsonProperty("id") MetricId id) {
        super("", id);
    }

    public Availability(String tenantId, MetricId id) {
        super(tenantId, id);
    }
